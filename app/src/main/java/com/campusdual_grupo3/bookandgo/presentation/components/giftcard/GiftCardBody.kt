    ...
    Column(
       ...
       /* ---------- Input Name ↓ ---------- */
        OutlinedTextField(
            ...
            label = { Text(stringResource(R.string.giftcard_input_name)) },
        ...
        OutlinedTextField(
            ...
            label = { Text(stringResource(R.string.giftcard_input_email)) },
            modifier = Modifier.fillMaxWidth(),
        ...
        OutlinedTextField(
            ...
            label = { Text(stringResource(R.string.giftcard_input_message)) },
